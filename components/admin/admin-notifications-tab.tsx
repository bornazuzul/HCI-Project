...
const MOCK_NOTIFICATIONS: AdminNotification[] = [
  {
    ...
    message:
      "Reminder: Beach Cleanup starts tomorrow at 9:00 AM. Please arrive 15 minutes early!",
  ...
  },
  {
    ...
    message:
      "Tree Planting event date moved to December 22nd due to weather forecasts.",
  ...
  },
  {
    ...
    message:
      "Join us for our monthly volunteer appreciation event this Friday at the community center.",
    sentTo: "All Users",
    sentDate: "2024-12-12",
    recipientCount: 156,
    type: "announcement",
