...
interface ApplyButtonProps {
  ...
  organizerId?: string; // Could be UUID or string
  betterAuthOrganizerId?: string; // Better Auth ID
...
export default function ApplyButton({
  ...
  // Check if user is the organizer - compare with both organizer ID types
  const isOrganizer =
    (organizerId && user?.id === organizerId) ||
    (betterAuthOrganizerId && user?.id === betterAuthOrganizerId);
