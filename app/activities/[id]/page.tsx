...
// Category colors mapping (consistent with list page)
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-base font-semibold text-gray-900 mb-2">
                          {activity.maxApplicants} available spots
                        </p>
                        <div className="w-full bg-gray-200 rounded-full h-1.5">
                          <div
                            ...
                            style={{
                              width: `${Math.min(
                                100,
                                (activity.maxApplicants / 50) * 100
                              )}%`,
                            }}
                          ></div>
                        </div>
                        <p className="text-xs text-gray-500 mt-1">
                          {activity.maxApplicants > 20
                            ? "Many spots available"
                            : activity.maxApplicants > 10
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-700 leading-relaxed text-base">
                    ...
                    making a positive impact. No prior experience is required -
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5">
                <div className="text-center mb-5">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Join {activity.maxApplicants} other volunteers in this
                    meaningful activity
                  </p>
                </div>

                <button className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold py-3 px-4 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-sm">
                  <svg
                    className="w-4 h-4"
                    fill="none"
                    stroke="currentColor"
